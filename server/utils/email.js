...
function sendMail(payload) {
  ...
  if (payload.sendType == 'login') {
    ...
    <br />
    `
  } else if (payload.sendType == 'register') {
    result.html = `
    <br />
    <br />
    <br />
    ...
    <h2 style="color: #383838;">${payload.email},您好！</h2>
    <h4 style="color: #9b9b9b;">
      您注册邮箱${payload.email}所需的 Arlanzon 令牌验证码为：
    </h4>
    <h1 style="color: #79a186; font-size: 30px;">${payload.check}</h1>
    <p style="color: #ff0000; font-size: 13px; line-height: 0;">
      验证码有效期5分钟
    ...
    <br />
    <h4 style="color: #9b9b9b;">
      您会收到这封自动产生的邮件，是由于有人在试图通过网页或移动设备在arlanzon在线社区注册账户。
    </h4>
    <h4 style="color: #9b9b9b;">
      没有人能够不访问这封电子邮件就访问您的帐户。
    </h4>
    <h4 style="color: #9b9b9b;">
      如果您未曾尝试注册，那么请更改您的 Arlanzon
      密码，并考虑更改您的电子邮件密码，以确保您的帐户安全。
    </h4>
    <br />
    <div
    ...
    <br />
    `
  } else { // payload.sendType == 'changePwd'
    result.html = `
    <br />
    <br />
    <br />
    ...
    <br />
    <h4 style="color: #9b9b9b;">
      您会收到这封自动产生的邮件，是由于有人在试图通过网页或移动设备修改您arlanzon社区账户的密码。
    </h4>
    <h4 style="color: #9b9b9b;">
      没有人能够不访问这封电子邮件就访问您的帐户。
    </h4>
